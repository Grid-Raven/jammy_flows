...
from ._safe_newton import inverse_bisection_n_newton_joint_func_and_grad
from ._safe_spline_tail import rational_quadratic_spline_with_linear_extension


# Keep the public import paths stable while replacing only the compile-targeted
# joint Newton solver and the unsafe spline-tail dispatch. The legacy non-joint
# Newton implementation retains its existing values and autograd behavior.
